...
public class FastMural implements Closeable, Comparable<FastMural> {
	private static final Logger logger = LoggerFactory.getLogger(FastMural.class);
	...
	public FastMural(String muralFilename) throws IOException {
	...
	public int compareTo(FastMural other) {
	...
	public static void main(String[] args) throws IOException {
		...
		FastMural mural = new FastMural(args[0]);
